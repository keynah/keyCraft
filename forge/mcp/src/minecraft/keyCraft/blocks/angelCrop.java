...
public class angelCrop extends BlockFlower
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public angelCrop(int par1)
    {
        super(par1);
        ...
        this.disableStats();
        this.setUnlocalizedName("angelCrop");
    }
    ...
    {
        return keyCore.angelSeeds.itemID;
    }
    ...
    {
        return keyCore.angelWheat.itemID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
    	...
    	{
    		this.iconArray[var2] = par1IconRegister.registerIcon("Keynah:dW_" + var2);
    	}
    	}
    }
