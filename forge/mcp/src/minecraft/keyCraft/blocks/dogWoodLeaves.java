...
public class dogWoodLeaves extends BlockLeavesBase implements IShearable
{
    public static final String[] TutLEAF_TYPES = new String[] {"Tut"};
    public static final String[][] field_94396_b = new String[][] {{"dogWoodLeaves"}, {"dogWoodLeaves"}};
    ...
    public dogWoodLeaves(int par1)
    {
        super(par1, Material.leaves, false);
        this.setTickRandomly(true);
        this.setCreativeTab(CreativeTabs.tabDecorations);
        setUnlocalizedName("dogWoodLeaves");
        setHardness(0.2F);
    ...
    {
    	blockIcon = iconRegister.registerIcon("Keynah:dogWoodLeaves");
    }
    ...
    {
        return keyCore.dogWoodSapling.blockID;
    }
