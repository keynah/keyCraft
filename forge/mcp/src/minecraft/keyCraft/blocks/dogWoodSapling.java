...
import keyCraft.worldgen.WorldGenDogTree;
...
public class dogWoodSapling extends BlockFlower
{
    ...
    public dogWoodSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.5F + f, f * 2.0F, 0.5F + f);
        this.setCreativeTab(CreativeTabs.tabDecorations);
        setUnlocalizedName("dogWoodSapling");
    }

    public void registerIcons(IconRegister iconRegister)
    {
             blockIcon = iconRegister.registerIcon("Keynah:dogWoodSapling");
    }
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new WorldGenDogTree(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            object = new WorldGenDogTree(true);
