...
public class doorDogWood extends Block
{
    private static final String[] doorIconNames = new String[] {"doorDogWood_lower", "doorDogWood_upper", "doorWood_lower", "doorWood_upper"};
    ...
    public doorDogWood(int par1, Material par2Material)
    {
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("Keynah:" + doorIconNames[i]);
    ...
    {
        return (par1 & 8) != 0 ? 0 : (this.blockMaterial == Material.iron ? Item.doorIron.itemID : keyCore.itemDogWoodDoor.itemID);
    }
