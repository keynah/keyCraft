...
public class hellWheatBlock extends BlockFlower
{
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    protected hellWheatBlock(int par1)
    {
        super(par1);
        ...
        this.disableStats();
        this.setUnlocalizedName("hellWheatBlock");
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("KeyCraft:hw_" + i);
        }
    }
}
