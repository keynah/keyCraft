...
public class itemDogWoodDoor extends Item
{
    private Material doorMaterial;

    public itemDogWoodDoor(int par1, Material par2Material)
    {
        super(par1);
        this.doorMaterial = par2Material;
        this.maxStackSize = 1;
        this.setCreativeTab(CreativeTabs.tabRedstone);
        this.setUnlocalizedName("itemDogWoodDoor");
    }
    ...
    {
             itemIcon = iconRegister.registerIcon("Keynah:itemDogWoodDoor");
    }
}
